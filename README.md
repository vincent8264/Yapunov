...
tar -xf sherpa-onnx-streaming-zipformer-en-2023-06-26.tar.bz2 -C models
uv run --extra asr edge-ai transcribe \
  --model-dir models/sherpa-onnx-streaming-zipformer-en-2023-06-26
```

It captures 200 ms, 16 kHz mono frames and prints changed partial text followed by
endpointed final text. Use `--device "Microphone name"` or a verified numeric device
